...
<html>
<head>
    <title>Laporan Stok Produk Berdasarkan Stok - {{ $seller->store_name }}</title>
    <style>
...
<body>
    <h1>Laporan Daftar Stok Produk Berdasarkan Stok</h1>
    <div class="info">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="stock-data" style="text-align: center;">{{ $item->stock }}</td>
