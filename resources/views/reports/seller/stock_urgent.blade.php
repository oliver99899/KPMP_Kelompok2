...
<html>
<head>
    <title>Laporan Stok Produk Segera Dipesan - {{ $seller->store_name }}</title>
    <style>
        ...
        .stock-critical { color: red; font-weight: bold; } 
    </style>
</head>
<body>
    <h1>Laporan Daftar Stok Produk Segera Dipesan </h1>
    <div class="info">
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="stock-critical" style="text-align: center;">{{ $item->stock }}</td>
